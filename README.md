...
3. Go to the Actions tab on your forked repo, click on "Build and Release YouTube Music+🗿" located on the left side. Click "Run workflow" button located on the right side.
